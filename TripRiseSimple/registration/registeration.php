    ...
    <body>
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form class="contact100-form validate-form" name="registration" id="registration" action="../scripts/registrationAction.php" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Phone is required">
                        <input class="input100" type="text" id="mobile" name="mobile" placeholder="Phone">
